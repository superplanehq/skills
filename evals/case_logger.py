"""Per-case interaction log writer. Adapted from superplane/agent/evals/case_logger.py."""
...
class CaseLogger:
    def __init__(self, run_id: str, case_names: list[str], output_root: Path) -> None:
